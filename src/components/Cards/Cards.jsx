  ...
  return (
        <div className = {styles.container}>
          <Grid container spacing={1} xs={12} justify='center'>
            ...
            <Grid item component={Card} xs={12} sm={2} className = {cx(styles.card, styles.infected)} >
              <CardContent>
            ...
            <Grid item component={Card} xs={12} sm={2} className = {cx(styles.card, styles.active)}>
              <CardContent>
            ...
            <Grid item component={Card}  xs={12} sm={2}  className = {cx(styles.card, styles.recovered)}>
              <CardContent>
            ...
            <Grid item component={Card} xs={12} sm={2} className = {cx(styles.card, styles.deaths)}>
              <CardContent>
